...
conn = mysql.connector.connect(user='root', password='guvi', host='localhost', database='phonepe')
...
if SELECT == "Home":
    ...
    with col2:
        st.video(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\upi.mp4")
    ...
    Data_Aggregated_Transaction_df= pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\agg_trans.csv')
    Data_Aggregated_User_Summary_df= pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\myfolder\Data_Aggregated_User_Summary_Table.csv')
    Data_Aggregated_User_df= pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\agg_user.csv')
    Scatter_Geo_Dataset =  pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_Districts_Longitude_Latitude.csv')
    Coropleth_Dataset =  pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_IndiaStates_TU.csv')
    Data_Map_Transaction_df = pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_Transaction_Table.csv')
    Data_Map_User_Table= pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\myfolder\Data_Map_User_Table.csv')
    Indian_States= pd.read_csv(r'C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\myfolder\Longitude_Latitude_State_Table.csv')
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\pulse-video.mp4")
    with col2:
        st.image(Image.open(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\PhonePe_Logo.jpg"),width = 500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\top.jpeg"),width = 400)
        with open(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\annual report.pdf","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open(r"C:\Users\HP\Desktop\Data\Phonepe_Pulse_Data_Visualization\report.jpeg"),width = 800)
...
if SELECT == "Contact":
    name = "Prerana Rajangane"
    mail = (f'{"Mail :"}  {"rajanganeprerana@gmail.com"}')
